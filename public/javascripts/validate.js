(function() {
  ...
  var validator = $("#register-form").kendoValidator({
    ...
    rules: {
      ...
      lengthField: function (input) {
        if(input.is('[name=key]')){
          console.log(input.val());
          console.log(Number.isInteger(input.val()));
          return input.val().length == 3 && Number.isInteger(input.val());
        }
      }*/
    },
    ...
    messages: {
      ...
      lengthField: function (input) {
        var msg = input.data("lengthFieldMsg");
        return msg;
      },*/
